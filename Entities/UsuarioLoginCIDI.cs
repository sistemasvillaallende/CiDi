            ...
            try
            {
                ...
                using (SqlConnection con = DALBase.GetConnection())
                {
                    ...
                    if (sqlDataReader.HasRows)
                    {
                        ...
                        int nombre_usuario = sqlDataReader.GetOrdinal("NOMBRE");
                        ...
                        while (sqlDataReader.Read())
                        {
                            ...
                            if (!sqlDataReader.IsDBNull(nombre_usuario))
                                usuario.nombre_usuario = sqlDataReader.GetString(nombre_usuario);
